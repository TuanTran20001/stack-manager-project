...
import Styless from './Dashboard1.module.css'
...
const Dashboard1 = ()=> {
  ...
  return (
    <div className={Styless.DashBoard1}>
            ...
            <div className={Styless.DashBoards}>
                <div className={Styless.DashTop1}>
                 ...
                 <div className={Styless.DashTop2}>
                    <div className={Styless.DashImg}>
                        <Link to='/Used'><img src={CS2} alt=""/></Link>
                        <Link to='/Used'><p style={{width: '70px'}}>Số thứ tự đã sử dụng</p></Link>
                    </div>

                    <div className={Styless.DashTexts}>
                        <Link to='/Used'><p>3.721</p></Link>
                        <Link to='/Used'><img src={Down32} alt="" /></Link>
                    </div>
                </div>

                <div className={Styless.DashTop3}>
                    <div className={Styless.DashImg}>
                        <Link to='/Wait'><img src={CS3} alt=""/></Link>
                        <Link to='/Wait'><p style={{width: '70px'}}>Số thứ tự đang chờ</p></Link>
                    </div>

                    <div className={Styless.DashTexts}>
                        <Link to='/Wait'><p style={{left: '40px'}}>468</p></Link>
                        <Link to='/Wait'><img src={Up56} alt="" /></Link>
                    </div>
                </div>

                <div className={Styless.DashTop4}>
                    <div className={Styless.DashImg}>
                        <Link to='/Skips'><img src={CS4} alt=""/></Link>
                        <Link to='/Skips'><p style={{width: '70px'}}>Số thứ tự đã bỏ qua</p></Link>
                    </div>

                    <div className={Styless.DashTexts}>
                        <Link to='/Skips'><p style={{left: '10px'}}>32</p></Link>
                        <Link to='/Skips'><img src={Down22} alt="" /></Link>
                    </div>
                </div>
                ...
                <div className={Styless.DashDown}>
                    ...
                    <div className={Styless.DashCombobox}>
                        <select 
                            ...
                            <option  id='default' value="/DashBoard1">Ngày</option>
                    ...
                    <div className={Styless.DashQuanlity}>
                        ...
                        <div className={Styless.Num13}>
                            <h1>13</h1>
                        </div>
                        <div className={Styless.Num19}>
                            <h1>19</h1>
                        </div>
                        <div className={Styless.Num31}>
                            <h1>31</h1>
                        </div>
