...
import Class from './ServiceAdd.module.css'
    ...
    return (
        <div className={Class.Add}>
            ...
            <div className={Class.AddHeader}>
                <p>Dịch vụ <img src={Arrow}/> <a className={Class.ds} href="/ServiceList">Danh sách dịch vụ</a> <img src={Arrow}/> <a href="/AddEquip">Thêm dịch vụ</a></p>
            </div>
            ...
            <div className={Class.BoxAdd}>
                ...
                <div className={Class.BoxUnder}>
                    ...
                    <div className={Class.BtnAdd}>
                        <Link to='/ServiceList'><button type='button' >Thêm dịch vụ</button></Link>
                    </div>
                </div>
            </div>
        </div>
